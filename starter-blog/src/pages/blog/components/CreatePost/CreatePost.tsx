...
export default function CreatePost() {
  ...
  const [addPost, addPostResult] = useAddPostMutation() // trả ra 1 array
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormData((pre) => ({ ...pre, featureImage: event.target.value }))}
          type='text'
          id='featuredImage'
          className='block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-blue-500'
      ...
      <div className='mb-6 flex items-center'>
        <input
          ...
          onChange={(event) => setFormData((pre) => ({ ...pre, published: event.target.checked }))}
          id='publish'
          type='checkbox'
